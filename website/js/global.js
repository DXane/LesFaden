...
function insertfaden(anzahl){
    ...
    var link="<div class=\"p-2\" style=\"width: 15%;\"><a href=\"faden.html\" class=\"box fadenbox\">    Zum Faden</a></div>";
...
function insertfaden_jquery(anzahl){
    var title = $('<div>',{class:'p-2 text-truncate'});
    title.text
...
function generateContentB(){
    ...
    string+="<a class=\"fadenlink\" href=\"./faden.html\">Zum Faden</a></div></div>";
    return string;
}
