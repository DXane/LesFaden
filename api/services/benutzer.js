...
serviceRouter.post("/benutzer/zugang", function(request, response) {
    ...
    try {
        ...
        response.setHeader("Set-Cookie","jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c; Domain=localhost")
        response.status(200).json(helper.jsonMsgOK(result));
    } catch (ex) {
